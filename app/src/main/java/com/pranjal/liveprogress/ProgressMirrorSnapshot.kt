    ...
    companion object {
        fun from(
            ...
            return ProgressMirrorSnapshot(
                ...
                shortText = candidate.shortCriticalText ?: candidate.progress.shortText,
                showProgressText = candidate.showProgressText,
                ...
                visualPayloadKey = candidate.visualPayloadKey,
                locked = locked,
                screenOff = screenOff,
